...
function SignInPageContent() {
  ...
  return (
    // Main page wrapper to center the card
    <div className="min-h-screen flex justify-center items-center bg-gray-200 p-4">
      {/* Card container. This holds both header and form. */}
      <div className="w-full max-w-md bg-white rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="relative px-6 py-8">
          ...
          <div className="relative z-10 flex items-center space-x-4">
            ...
            {/* Make logo container a circle (w-20 h-20) */}
            <div className="bg-white rounded-full w-20 h-20 flex items-center justify-center">
              <Image
                src="/images/instaaid-logo.png"
                alt="InstaAid Logo"
                // Image size is smaller than container for padding
                width={64}
                height={64}
