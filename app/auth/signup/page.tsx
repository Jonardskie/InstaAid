  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-500">
      <div className="border-[10px] border-black rounded-3xl w-[375px] h-[812px] shadow-2xl overflow-hidden relative bg-white">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-black rounded-b-2xl w-36 h-6 z-10"></div>
                ...
                {vehicleOr ? (
                  <div className="relative flex items-center justify-between border border-gray-200 rounded-lg bg-gray-50 p-2">
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <p className="text-sm text-gray-600 truncate max-w-[140px]">{vehicleOr.name}</p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="relative flex items-center justify-between border border-gray-200 rounded-lg bg-gray-50 p-2">
                    <div className="flex items-center space-x-3">
                      <img
                        ...
                        className="w-20 h-20 object-cover rounded-md border"
                      />
                      <p className="text-sm text-gray-600 truncate max-w-[140px]">{vehicleCr.name}</p>
                    </div>
                    <button
                      type="button"
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-lg bg-white rounded-2xl p-6 shadow-xl overflow-y-auto max-h-[80vh]">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              ...
              <p>
                Welcome to InstaAid, an intelligent road accident detection and emergency response application. By
                accessing or using this app, you agree to comply with these Terms.
              </p>
              <p>
                <strong>1.</strong> By using InstaAid, you agree to these Terms.
              </p>
              <p>
                <strong>2.</strong> Description: Detect accidents, send alerts, and log crash data.
              </p>
              <p>
                <strong>3.</strong> User must provide accurate info and not misuse the app.
              </p>
              <p>
                <strong>4.</strong> Disclaimer: We are not liable for delays or failures due to signal loss or
                emergencies.
              </p>
              <p>
                <strong>5.</strong> IP: All rights reserved.
              </p>
              <p>
                <strong>6.</strong> Terms may change anytime.
              </p>
              <p>
                <strong>7.</strong> Violators may be suspended.
              </p>
              <p>
                <strong>8.</strong> Governed by PH law.
              </p>
            </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-lg bg-white rounded-2xl p-6 shadow-xl overflow-y-auto max-h-[80vh]">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              ...
              <p>
                <strong>1.</strong> We collect personal, location, and sensor data.
              </p>
              <p>
                <strong>2.</strong> Used only for emergency response and system improvements.
              </p>
              <p>
                <strong>3.</strong> Shared only with emergency contacts/services.
              </p>
              <p>
                <strong>4.</strong> Data is encrypted and secured.
              </p>
              <p>
                <strong>5.</strong> Users may access, update, or delete data.
              </p>
              <p>
                <strong>6.</strong> Retained while account is active or as required by law.
              </p>
              <p>
                <strong>7.</strong> Not for children under 13 without consent.
              </p>
              <p>
                <strong>8.</strong> Contact: support@instaaid.com
              </p>
            </div>
            <div className="mt-4 text-right">
        ...
        <div className="fixed inset-0 flex items-center justify-center p-3">
          <Dialog.Panel className="mx-auto w-full max-w-[350px] rounded-[20px] bg-white px-4 py-4 shadow-xl">
            ...
            <p className="mt-3 text-[13px] leading-5 text-slate-600">
              ...
              <strong className="text-slate-700">{email}</strong>. Enter it below to verify
