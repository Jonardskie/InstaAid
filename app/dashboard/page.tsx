  ...
  useEffect(() => {
    ...
    unsubscribers.push(
      onValue(ref(rtdb, "triggered"), (snap) => {
        const val = snap.val();
        if (val === true) startAccidentCountdown();
      })
    );
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="flex gap-3 mt-4 w-full">
                  <Button
                    ...
                    className="bg-gray-200 text-black hover:bg-gray-300 flex-1 flex gap-2 justify-center"
                  >
                    <XCircle className="w-5 h-5" /> Cancel
                  </Button>
                  <Button
                    onClick={confirmAccident}
                    className="bg-red-600 hover:bg-red-700 text-white flex-1 flex gap-2 justify-center"
                  >
