...
export default function HomePage() {
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ backgroundColor: '#182F66' }}>
      ...
      <div className="text-center space-y-8">
        ...
        <div className="pt-8">
          ...
          */}
          ...
          <Button className="bg-[#173C94] hover:bg-[#1E4ABF] text-white px-12 py-5 rounded-full text-lg font-semibold w-50">
            Proceed
          </Button>
